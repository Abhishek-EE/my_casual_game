...
// configuration step. It creates a namespace called `my_casual_game`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        my_casual_game::cmake::project_name,
        my_casual_game::cmake::project_version));// version string, acquired
